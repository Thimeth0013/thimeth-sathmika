      ...
      <section className="min-h-screen relative py-10 bg-black overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 sm:px-6 z-10">
          ...
          >
            ...
            <h1 className="text-xl sm:text-2xl font-medium text-left text-blue-800">My work</h1>
          </motion.div>
          <motion.h1
            className="text-4xl sm:text-5xl font-bold text-left mt-4 ml-4 mb-20 sm:ml-8"
            variants={titleVariants}
            initial="hidden"
            animate={isInView ? 'visible' : 'hidden'}
          >
